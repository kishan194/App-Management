                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control border" placeholder="Upload Pk"
                                                    name="apk_path">
                                                @error('apk_path')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="example-text-input" class="form-control-label">Version
                                                    Name:</label>
                                                <input class="form-control" type="text" placeholder="Version_name"
                                                    name="version_name" value="{{ old('version_name') }}">
                                                @error('version_name')
                                                    <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
